...
ConVar 	cTankChance, cCountAirdrops, cTimeOpen, cColorFlare, cFlare, cFlareLenght, 
		...
		cAirHeight, cRemoveCrate, cRemoveItems, cStartPlane, cTimerPlane, cItemsCount;
...
public void OnPluginStart()
{
	...
	cStartPlane			=		CreateConVar("airdrop_start_time"		, 	"0"			, "Enable AC130 on mapstart?"								, FCVAR_NONE);
