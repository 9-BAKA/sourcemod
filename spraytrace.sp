...
public OnPluginStart() {
	...
	RegConsoleCmd("sm_spraytrace", TestTrace, "Look up the owner of the logo in front of you.");
	RegConsoleCmd("sm_removespray", RemoveSpray, "Remove the logo in front of you.");
	RegConsoleCmd("sm_adminspray", AdminSpray, "Sprays the named player's logo in front of you.");
