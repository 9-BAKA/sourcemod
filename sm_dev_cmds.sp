...
public void OnPluginStart()
{
	...
	if( g_iGAMETYPE == GAME_L4D || g_iGAMETYPE == GAME_L4D2 )
	{
		...
		RegAdminCmd("sm_coop",			CmdCoop,		ADMFLAG_ROOT);
		RegAdminCmd("sm_realism",		CmdRealism,		ADMFLAG_ROOT);
		RegAdminCmd("sm_survival",		CmdSurvival,	ADMFLAG_ROOT);
		RegAdminCmd("sm_versus",		CmdVersus,		ADMFLAG_ROOT);
