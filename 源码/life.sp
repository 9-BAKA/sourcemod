...
new Handle:g_hCvar_ReviveEnabled;
...
public void OnPluginStart()
{
	...
	//g_hCvar_ReviveEnabled = CreateConVar("Revive_enable", "1", "设置是否允许代码复活");
	g_hCvar_HealthEnabled = CreateConVar("Health_enable", "0", "设置是否允许代码加血");
...
SelfHelp(client)
{
	...
	PrintToChatAll("\x02[加血] \x03%s \x04加血成功!", name); 
