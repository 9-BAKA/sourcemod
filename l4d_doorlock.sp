...
public OnPluginStart()
{
	...
	cvarInvulnerable = CreateConVar("l4d2_dlock_godmode", "1", "幸存者冻结/锁定无伤");
	cvarFreezeNodoor = CreateConVar("l4d2_dlock_freezenodoor", "1", "无安全门冻结幸存者");
	cvarPrepareTime1r = CreateConVar("l4d2_dlock_prepare1st", "100", "等待游戏时间");
	cvarPrepareTime2r = CreateConVar("l4d2_dlock_prepare2nd", "50", "重启等待游戏时间");
