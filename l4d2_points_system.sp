...
#define MSGTAG "\x04[积分]\x01"
#define MSGTAG2 "\x04[积分]\x01 "
...
{	
	...
	StartPoints = CreateConVar("l4d2_points_start", "0", "Points to start each round/map with.", 0);
	Notifications = CreateConVar("l4d2_points_notify", "1", "Show messages when points are earned?", 0);
	Enable = CreateConVar("l4d2_points_enable", "1", "Enable Point System?", 0);
	Modes = CreateConVar("l4d2_points_modes", "coop,realism,versus,teamversus", "Which game modes to use Point System", 0);
	ResetPoints = CreateConVar("l4d2_points_reset_mapchange", "versus,teamversus", "Which game modes to reset point count on round end and round start", 0);
	...
	PointsHunting = CreateConVar("l4d2_points_hunting_rifle", "10", "How many points the hunting rifle costs", 0);
	PointsAuto = CreateConVar("l4d2_points_autoshotgun", "10", "How many points the autoshotgun costs", 0);
	PointsPump = CreateConVar("l4d2_points_pump", "7", "How many points the pump shotgun costs", 0);
	PointsGasCan = CreateConVar("l4d2_points_gascan", "5", "How many points the gas can costs", 0);
	PointsPropane = CreateConVar("l4d2_points_propane", "2", "How many points the propane tank costs", 0);
	PointsMagnum = CreateConVar("l4d2_points_magnum", "6", "How many points the magnum costs", 0);
	PointsSSMG = CreateConVar("l4d2_points_ssmg", "7", "How many points the silenced smg costs", 0);
	PointsMP5 = CreateConVar("l4d2_points_mp5", "7", "How many points the mp5 costs", 0);
	PointsAK = CreateConVar("l4d2_points_ak", "12", "How many points the ak47 costs", 0);
	PointsSCAR = CreateConVar("l4d2_points_scar", "12", "How many points the scar costs", 0);
	PointsSG = CreateConVar("l4d2_points_sg", "12", "How many points the sg552 costs", 0);
	PointsMilitary = CreateConVar("l4d2_points_military_sniper", "14", "How many points the military sniper costs", 0);
	PointsAWP = CreateConVar("l4d2_points_awp", "15", "How many points the awp costs", 0);
	PointsScout = CreateConVar("l4d2_points_scout", "10", "How many points the scout sniper costs", 0);
	PointsSpas = CreateConVar("l4d2_points_spas", "10", "How many points the spas shotgun costs", 0);
	PointsChrome = CreateConVar("l4d2_points_chrome", "7", "How many points the chrome shotgun costs", 0);
	PointsGL = CreateConVar("l4d2_points_grenade", "15", "How many points the grenade launcher costs", 0);
	PointsM60 = CreateConVar("l4d2_points_m60", "50", "How many points the m60 costs", 0);
	PointsOxy = CreateConVar("l4d2_points_oxygen", "2", "How many points the oxgen tank costs", 0);
	...
	PointsKnife = CreateConVar("l4d2_points_knife", "6", "How many points the knife costs", 0);
	PointsShield = CreateConVar("l4d2_points_shield", "6", "How many points the shield costs", 0);
	PointsTonfa = CreateConVar("l4d2_points_tonfa", "4", "How many points the tonfa costs", 0);
	PointsFireaxe = CreateConVar("l4d2_points_fireaxe", "4", "How many points the fireaxe costs", 0);
	PointsGuitar = CreateConVar("l4d2_points_guitar", "4", "How many points the guitar costs", 0);
	PointsPan = CreateConVar("l4d2_points_pan", "4", "How many points the frying pan costs", 0);
	PointsCBat = CreateConVar("l4d2_points_cricketbat", "4", "How many points the cricket bat costs", 0);
	PointsCrow = CreateConVar("l4d2_points_crowbar", "4", "How many points the crowbar costs", 0);
	PointsClub = CreateConVar("l4d2_points_golfclub", "6", "How many points the golf club costs", 0);
	PointsSaw = CreateConVar("l4d2_points_chainsaw", "10", "How many points the chainsaw costs", 0);
	PointsPipe = CreateConVar("l4d2_points_pipe", "8", "How many points the pipe bomb costs", 0);
	PointsMolly = CreateConVar("l4d2_points_molotov", "8", "How many points the molotov costs", 0);
	PointsBile = CreateConVar("l4d2_points_bile", "8", "How many points the bile jar costs", 0);
	PointsKit = CreateConVar("l4d2_points_kit", "20", "How many points the health kit costs", 0);
	PointsDefib = CreateConVar("l4d2_points_defib", "20", "How many points the defib costs", 0);
	PointsAdren = CreateConVar("l4d2_points_adrenaline", "10", "How many points the adrenaline costs", 0);
	PointsPills = CreateConVar("l4d2_points_pills", "10", "How many points the pills costs", 0);
	PointsEAmmo = CreateConVar("l4d2_points_explosive_ammo", "10", "How many points the explosive ammo costs", 0);
	PointsIAmmo = CreateConVar("l4d2_points_incendiary_ammo", "10", "How many points the incendiary ammo costs", 0);
	PointsEAmmoPack = CreateConVar("l4d2_points_explosive_ammo_pack", "15", "How many points the explosive ammo pack costs", 0);
	...
	SValueHeadSpree = CreateConVar("l4d2_points_headshots_value", "4", "How many points does killing a certain amount of infected with headshots earn", 0);
	SNumberHead = CreateConVar("l4d2_points_headshots", "20", "How many kills you need to earn a head hunter bonus", 0);
	SSIKill = CreateConVar("l4d2_points_sikill", "1", "How many points does killing a special infected earn", 0);
	STankKill = CreateConVar("l4d2_points_tankkill", "2", "How many points does killing a tank earn", 0);
	SWitchKill = CreateConVar("l4d2_points_witchkill", "4", "How many points does killing a witch earn", 0);
	SWitchCrown = CreateConVar("l4d2_points_witchcrown", "2", "How many points does crowning a witch earn", 0);
	SHeal = CreateConVar("l4d2_points_heal", "5", "How many points does healing a team mate earn", 0);
	SHealWarning = CreateConVar("l4d2_points_heal_warning", "1", "How many points does healing a team mate who did not need healing earn", 0);
	SProtect = CreateConVar("l4d2_points_protect", "1", "How many points does protecting a team mate earn", 0);
	SRevive = CreateConVar("l4d2_points_revive", "3", "How many points does reviving a team mate earn", 0);
	SLedge = CreateConVar("l4d2_points_ledge", "1", "How many points does reviving a hanging team mate earn", 0);
	SDefib = CreateConVar("l4d2_points_defib_action", "5", "How many points does defibbing a team mate earn", 0);
	STBurn = CreateConVar("l4d2_points_tankburn", "2", "How many points does burning a tank earn", 0);
	STSolo = CreateConVar("l4d2_points_tanksolo", "8", "How many points does killing a tank single-handedly earn", 0);
	SWBurn = CreateConVar("l4d2_points_witchburn", "1", "How many points does burning a witch earn", 0);
	STag = CreateConVar("l4d2_points_bile_tank", "2", "How many points does biling a tank earn", 0);
	IChoke = CreateConVar("l4d2_points_smoke", "2", "How many points does smoking a survivor earn", 0);
	IPounce = CreateConVar("l4d2_points_pounce", "1", "How many points does pouncing a survivor earn", 0);
	ICarry = CreateConVar("l4d2_points_charge", "2", "How many points does charging a survivor earn", 0);
	IImpact = CreateConVar("l4d2_points_impact", "1", "How many points does impacting a survivor earn", 0);
	IRide = CreateConVar("l4d2_points_ride", "2", "How many points does riding a survivor earn", 0);
	ITag = CreateConVar("l4d2_points_boom", "1", "How many points does booming a survivor earn", 0);
	...
	PointsSmoker = CreateConVar("l4d2_points_smoker", "4", "How many points does a smoker cost", 0);
	PointsCharger = CreateConVar("l4d2_points_charger", "6", "How many points does a charger cost", 0);
	PointsBoomer = CreateConVar("l4d2_points_boomer", "5", "How many points does a boomer cost", 0);
	PointsSpitter = CreateConVar("l4d2_points_spitter", "6", "How many points does a spitter cost", 0);
	PointsIHeal = CreateConVar("l4d2_points_infected_heal", "6", "How many points does healing yourself as an infected cost", 0);
	PointsWitch = CreateConVar("l4d2_points_witch", "20", "How many points does a witch cost", 0);
	PointsTank = CreateConVar("l4d2_points_tank", "30", "How many points does a tank cost", 0);
	PointsTankHealMult = CreateConVar("l4d2_points_tank_heal_mult", "3", "How much l4d2_points_infected_heal should be multiplied for tank players", 0);
	...
	CatShotguns = CreateConVar("l4d2_points_cat_shotguns", "1", "Enable shotguns catergory", 0);
	CatHealth = CreateConVar("l4d2_points_cat_health", "1", "Enable health catergory", 0);
	CatUpgrades = CreateConVar("l4d2_points_cat_upgrades", "1", "Enable upgrades catergory", 0);
	CatThrowables = CreateConVar("l4d2_points_cat_throwables", "1", "Enable throwables catergory", 0);
...
public Action:Command_RBuy(client, args)
{
	...
	else if (args == 0 && IsClientInGame(client))
	{
		...
		else if(StrEqual(item[client], "give ammo", false))
		{
			...
			{
				new offset = FindDataMapInfo(client, "m_iAmmo");
		...
		case MenuAction_Select:
		{
			...
			else if (StrEqual(choice, "yes", false))
			{
				...
				else if(StrEqual(item[param1], "give ammo", false))
				{
					...
					{
						new offset = FindDataMapInfo(param1, "m_iAmmo");
