...
public OnPluginStart()
{
	...
	CreateConVar(					 "l4d2_WeaponUnlock", 	PLUGIN_VERSION, "Weapon Unlock version.", 				FCVAR_SPONLY|FCVAR_REPLICATED|FCVAR_NOTIFY|FCVAR_DONTRECORD);
	cvarEnabled = 		CreateConVar("l4d2_wu_enable", 		"1", 			"Is Weapon Unlock plug-in enabled?", 	FCVAR_DONTRECORD);
	cvarAWPEnabled = 	CreateConVar("l4d2_wu_awp", 		"1", 			"Enable AWP sniper rifle?", 			0);
	cvarMP5Enabled = 	CreateConVar("l4d2_wu_mp5", 		"1", 			"Enable MP5 submachine gun?", 			0);
	cvarScoutEnabled = 	CreateConVar("l4d2_wu_scout", 		"1", 			"Enable Scout sniper rifle?", 			0);
	cvarSG552Enabled = 	CreateConVar("l4d2_wu_sg552", 		"1", 			"Enable SG552 assault rifle?", 			0);
