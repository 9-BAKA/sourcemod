...
{
	CreateConVar("l4d2_msg_system_zh_version", "1.0", "l4d2_msg_system_zh Version", 270592, false, 0.0, false, 0.0);
	l4d2_msg_system_zh_heal_info = CreateConVar("l4d2_msg_system_zh_heal_info", "1", "显示治疗信息", 0, false, 0.0, false, 0.0);
	l4d2_msg_system_zh_tank_spawn = CreateConVar("l4d2_msg_system_zh_tank_spawn", "1", "开启tank产生提示", 262144, false, 0.0, false, 0.0);
	l4d2_msg_system_zh_tank_killed = CreateConVar("l4d2_msg_system_zh_tank_killed", "1", "杀死tank提示", 262144, false, 0.0, false, 0.0);
	l4d2_msg_system_zh_witch_killed = CreateConVar("l4d2_msg_system_zh_witch_killed", "1", "杀死witch提示", 262144, false, 0.0, false, 0.0);
	l4d2_msg_system_zh_witch_harasser_set = CreateConVar("l4d2_msg_system_zh_witch_harasser_set", "1", "惊动witch提示", 262144, false, 0.0, false, 0.0);
	l4d2_msg_system_zh_player_death = CreateConVar("l4d2_msg_system_zh_player_death", "1", "玩家死亡提示", 262144, false, 0.0, false, 0.0);
	l4d2_msg_system_zh_create_panic_event = CreateConVar("l4d2_msg_system_zh_create_panic_event", "1", "触发警报提示", 262144, false, 0.0, false, 0.0);
	l4d2_msg_system_zh_player_incapacitated = CreateConVar("l4d2_msg_system_zh_player_incapacitated", "1", "倒地提示", 262144, false, 0.0, false, 0.0);
	l4d2_msg_system_zh_player_in_out = CreateConVar("l4d2_msg_system_zh_player_in_out", "1", "玩家进入退出提示", 262144, false, 0.0, false, 0.0);
	l4d2_msg_system_zh_kill_in = CreateConVar("l4d2_msg_system_zh_kill_in", "1", "击杀特感提示（聊天框内）", 262144, false, 0.0, false, 0.0);
	l4d2_msg_system_zh_save_up = CreateConVar("l4d2_msg_system_zh_save_up", "1", "救起玩家提示", 262144, false, 0.0, false, 0.0);
	l4d2_msg_system_zh_use_def = CreateConVar("l4d2_msg_system_zh_use_def", "1", "复活玩家提示", 262144, false, 0.0, false, 0.0);
	HookEvent("heal_success", HealSuccess, EventHookMode:1);
	HookEvent("tank_spawn", tankSpawn, EventHookMode:1);
	HookEvent("witch_killed", witchKilled, EventHookMode:1);
	HookEvent("witch_harasser_set", witchHrasserSet, EventHookMode:1);
	HookEvent("tank_killed", tankKilled, EventHookMode:1);
	HookEvent("player_death", playerDeath, EventHookMode:1);
	HookEvent("player_incapacitated_start", playerIncapacitated, EventHookMode:1);
